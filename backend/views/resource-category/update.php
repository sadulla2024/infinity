...
$this->title = Yii::t('main', 'Update Resource Category');

$this->params['breadcrumbs'][] = ['label' => Yii::t('main', 'Resource Categories'), 'url' => ['index']];
...

{
    ...
    $lang_model = \common\models\ResourceCategoryLang::find()->andFilterWhere(['parent' => $model->id, 'lang' => $language->id])->one();
    ...
    if (empty($lang_model) || $lang_model == NULL) {
        ...
        $lang_model = new \common\models\ResourceCategoryLang();

        $action = "/resource-category-lang/create";
        ...
        $lang_model = \common\models\ResourceCategoryLang::findOne($lang_model->id);

        $action = "/resource-category-lang/update/" . $lang_model->id;
    ...
    $langs[] = [
        ...
        'content' => $this->render('/resource-category-lang/_form', [
