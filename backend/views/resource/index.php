...
$this->title = Yii::t('main', 'Resurslar');
        ...
        <div class="panel-body no-padding">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                        ...
                        <?= Html::a( Yii::t('main',"Resurs Qo'shish"), ['create'], ['class' => 'btn btn-success']) ?>
...
[
                                ...
                                [
                                    ...
                                    'filter' => Html::activeDropDownList($searchModel, 'category_id', Arrayhelper::map(\common\models\ResourceCategory::find()->where('status>-1')->orderBy('id')->asArray()->all(), 'id', 'name'),['class'=>'full-width', 'data-init-plugin' => 'select2','prompt' => Yii::t('main', 'Select Category')]),
