...
$this->title = Yii::t('main', 'Resursni tahrirlash');

$this->params['breadcrumbs'][] = ['label' => Yii::t('main', 'Resurslar'), 'url' => ['index']];
...

{
    ...
    $lang_model = \common\models\ResourceLang::find()->andFilterWhere(['parent' => $model->id, 'lang' => $language->id])->one();
    ...
    if (empty($lang_model) || $lang_model == NULL) {
        ...
        $lang_model = new \common\models\ResourceLang();

        $action = "/resource-lang/create";
        ...
        $lang_model = \common\models\ResourceLang::findOne($lang_model->id);

        $action = "/resource-lang/update/" . $lang_model->id;
    ...
    $langs[] = [
        ...
        'content' => $this->render('/resource-lang/_form', [
