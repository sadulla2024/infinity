...
$image = \common\components\StaticFunctions::getImage($model,'page','main_image');
...
$postImages = $model->getPageGallery()['images'];
    ...
    <div class="container">
        ...
        <div class="page-breadcrumb mb-15">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?=Yii::t('main','another')?></li>
